...
class Posts(models.Model):
    ...
    content - Содержимое поста TODO ОГРАНИЧИТЬ ДЛИНУ СУЩНОСТИ
    picture - Изображение относящееся к посту. По умолчанию None TODO ЗАПИЛИТЬ ДОБАВЛЕНИЕ НЕСКОЛЬКИХ IMG
